            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="post" action="{{url('/adminlogin')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="admin_pass" placeholder="Password">
                </div>
                <div class="form-group d-fle x align-items-center justify-content-between">
